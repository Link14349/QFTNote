...
\begin{equation}
    \int\mathcal D\pi_j\braket{\phi_{j+1}|\pi_j}\bra{\pi_j}\exp{-i\Delta tH(t_j)}\ket{\phi_j}=N\exp{i\Delta t\left\{\int\d^3x\left(\frac{(\phi_{j+1}(x)-\phi_j(x))^2}{2\Delta t^2}-V(\phi_j)\right)\right\}},
\end{equation}
其中$N$还是某一归一化系数.
