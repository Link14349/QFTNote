...
\end{align}
若仍然有$\mathcal D\delta\phi=0$(这是一个假设, 若不满足, 则是anormaly), 其中$\delta\phi=\epsilon\Delta\phi=\epsilon\mathcal F[\phi]-\epsilon\xi^\nu\partial_\nu\phi$. 那么我们可以得到
\begin{align}
...
\end{align}
在没有anormaly的情况下, 关联函数意义下的流守恒依然是被满足的. 如果我们再对$J$做变分可以得到, 乘以其他$\phi$后会存在接触项, 这被称为Ward恒等式.
