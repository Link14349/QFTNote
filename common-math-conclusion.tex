...
\subsection{维数调控圈图计算的参考公式}
\begin{align}
    \int \nd{d}{\ell} \frac{1}{(\ell^2 - \Delta)^n} &= \frac{(-1)^n i}{(4\pi)^{d/2}} \frac{\Gamma(n-\frac{d}{2})}{\Gamma(n)} \left(\frac{1}{\Delta}\right)^{n-\frac{d}{2}} \tag{A.44} \\[1ex]
    \int \nd{d}{\ell} \frac{\ell^2}{(\ell^2 - \Delta)^n} &= \frac{(-1)^{n-1} i}{(4\pi)^{d/2}} \frac{d}{2} \frac{\Gamma(n-\frac{d}{2}-1)}{\Gamma(n)} \left(\frac{1}{\Delta}\right)^{n-\frac{d}{2}-1} \tag{A.45} \\[1ex]
    \int \nd{d}{\ell} \frac{\ell^\mu \ell^\nu}{(\ell^2 - \Delta)^n} &= \frac{(-1)^{n-1} i}{(4\pi)^{d/2}} \frac{g^{\mu\nu}}{2} \frac{\Gamma(n-\frac{d}{2}-1)}{\Gamma(n)} \left(\frac{1}{\Delta}\right)^{n-\frac{d}{2}-1} \tag{A.46} \\[1ex]
    \int \nd{d}{\ell} \frac{(\ell^2)^2}{(\ell^2 - \Delta)^n} &= \frac{(-1)^n i}{(4\pi)^{d/2}} \frac{d(d+2)}{4} \frac{\Gamma(n-\frac{d}{2}-2)}{\Gamma(n)} \left(\frac{1}{\Delta}\right)^{n-\frac{d}{2}-2} \tag{A.47} \\[1ex]
