...
而依葫芦画瓢我们有
\begin{align}
    \braket{\phi_x^2\phi_2}&=\int\d^4y iD_{y2}(\Box_y+m^2)\braket{\phi_x^2\phi_y}\\
...
于是最后整理得
\begin{align}
    \braket{\phi_1\phi_2}=D_{12}-\left(\frac g2\right)^2\int \d^4x\d^4y\big(&2D_{1x}D_{xy}D_{xy}D_{y2}+D_{1x}D_{xx}D_{yy}D_{y2}\notag\\
    &+2D_{1x}D_{xy}D_{yy}D_{x2}\big)\label{2pt-correlation-expansion-schwinger-dyson}
\end{align}
