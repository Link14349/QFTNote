...
设$N=a^\dagger a$, $N$是幺正算符, $N^\dagger=N$, 我们有
\begin{align}
...
\begin{align}
    \braket{x|\alpha}=\left(\frac{m\omega}\pi\right)^{\frac14}\exp{-\frac12m\omega(x-\sqrt{\frac 2{m\omega}}\alpha)}
\end{align}
