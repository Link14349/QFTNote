...
\begin{align}
    \vec\mu_B=\frac12g\frac{e\vec\sigma}{2m},
\end{align}
其中$g$为修正因子,
\begin{align}
    g=2+\frac{e^2}{4\pi^2}+\cdots\approx2.0023228.
\end{align}
在后面我们会看到电子反常磁矩的来源正是量子场论对电子光子相互作用的一圈修正, 具体来说, 也就是$\begin{tikzpicture}[line width=1pt, baseline=(current bounding box.center)]
    % 费米子线（左上进，左下出）
