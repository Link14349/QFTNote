...
我们首先引入反项
\begin{align}
    \mathcal L=-\frac14F_r^2+\bar\psi_r(i\slashed\partial-m)\psi_r-e\bar\psi_r\slashed A_r\psi_r-\frac14\delta_A F_r^2+\delta_\psi\bar\psi_r(i\slashed\partial)\psi_r-\delta_m\bar\psi_r\psi_r-\delta_e\bar\psi_r\slashed A_r\psi_r.
\end{align}
得到反项顶点
\begin{align}
    % 第一行：光子自能计数项
