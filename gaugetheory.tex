...
\begin{align}
    Z[J]=\int\mathcal DA\exp{i\int\d^4x(-\frac14 F^2-\frac{(\partial_\mu A^\mu)}{2\xi}+J\cdot A)}.
\end{align}
从而得到规范固定后的Lagrangian
\begin{align}
    \mathcal L_{GF}=-\frac14 F^2-\frac{(\partial_\mu A^\mu)}{2\xi}+J\cdot A=\frac12 A^\mu(g_{\mu\nu}\partial^2-(1-\frac1\xi)\partial_\mu\partial_\nu)A^\nu+J_\mu A^\mu.
\end{align}
...
\begin{align}
    \mathcal L_{GF}=-\frac14 F^2-\frac{(\partial_\mu A^\mu)}{2\xi}+J\cdot A\notag,
\end{align}
进行计算.
